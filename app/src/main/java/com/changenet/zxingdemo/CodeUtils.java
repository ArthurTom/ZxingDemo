...
/**
 * 作者：Administrator
 * 时间：on 2018/9/17 09:57
 * 功能：根据内容和图片生成二维码
 */
public class CodeUtils {


    // 宽度值，影响中间图片大小，设置二维码中图片的大小
    ...
    public static Bitmap createCode(Context context, String content, Bitmap logo) throws WriterException {
        ...
        // 设置字符编码，支持中文。默认的是ISO-8859-1,不支持中文
        hst.put(EncodeHintType.CHARACTER_SET, "UTF-8");
        // 设置二维码，四周的白边的宽度:像素。
        hst.put(EncodeHintType.MARGIN, 2);
        // 设置二维码容错率，在二维码残缺的时候，也可能扫描成功，"H"是最高容错率，达到30%
        hst.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.H);

        /*
         * 功能：关键步骤：生成二维码矩阵信息，使用Zxing库
         *
         * @param  content  二维码的内容
         * @param  QR_CODE  生成二维码
         * @param  width    生成的二维码的宽
         * @param  height   生成的二维码的高
         * @param  hst      生成器的相关配置
         * */
